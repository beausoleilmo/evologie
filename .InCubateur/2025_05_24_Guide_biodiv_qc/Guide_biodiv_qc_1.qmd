...
description: "Est-ce que les données de biodiversité issues de la science citoyenne permettraientt l'élaboration d'un guide d'identification des espèces fréquemment observées?"
...
Les chiffres en lien avec la biodiversité sont simplement incroyables. Voici quelques statistiques. Le site web [ChecklistBank](https://www.checklistbank.org), une référence qui catalogue l'ensemble des espèces connues, répertorie plus de 2.2 millions d'organismes sur la terre. Mais il en existe beaucoup plus. Les estimations du nombre d'espèces sur la terre sont très large allant de quelques millions à plusieurs milliards. Un article propose même un potentiel de six milliards, en incluant le plus de vivant possible, tout en excluant les virus [@larsenInordinateFondnessMultiplied2017].
...
Le rapport de la Plateforme intergouvernementale scientifique et politique sur la biodiversité et les services écosystémiques (IPBES), colligé par un groupe internationnal d'experts sur la biodiversité, [rapporte qu'environ 1 million d'espèces](https://www.ipbes.net/news/Media-Release-Global-Assessment) animales et végétales sont menacées d'extinction [@ipbesResumeDecideurs2016]. Depuis les années 1970, la taille des populations animale a chuté de 73%, selon l'[indice planète vivante](https://www.livingplanetindex.org/lpi).
...
Nous avons passé une partie de notre histoire à penser que nous étions positionné au centre de l'univers. Maintenant, nous en savons autrement. Par contre, nous avons encore beaucoup de chemin à faire pour réalisé que nous ne sommes pas la partie la plus importante de la nature. Nous formons un tout avec l'environnement. Nous en sommes dépendant pour y vivre en santé physique et psychologique. Jamais dans toute l'histoire de l'humanité, la biodiversité ne s'est détérioré aussi rapidement dans le monde [@ipbesResumeDecideurs2016]. Par contre, tout le monde peut y faire quelque chose. Une des premières étapes est de s'intéresser au sujet de la biodiversité!

## On ne protège que ce qu'on connaît

Au Canada, le manque d'information en lien avec la biodiversité est un enjeu de haute importance. Le territoire est vaste et la distribution des humains dans ses terre est inégale. À l'heure actuelle, il n'existe pas de coordination nationale qui permettrait d'obtenir un portrait éclairé sur l'état de la biodiversité et des tendances spatiales et temporelles @gonzalezBiodiversityObservationNetwork2025. Cela veut dire que l'information sur la biodiversité est très morcelé et il est difficile de savoir l'état actuel véritable. Mais pire, nous n'avons pas moyen de savoir si des actions on un effet plus ou moins important sur la biodiversité puisque nous n'avons pas un bon portrait dans le temps des tendances des populations de la diversité des organismes que nous cotoyons.

Heureusement, la technologie dans nos poches peut aider à collecter des données de biodiveristé. Aujourd'hui, les téléphones intelligents peuvent prendre des points GPS lors de la prise d'une photo. En capturant l'image d'une bibitte, nous pouvons l'exporter sur des plateformes de collecte de données de biodiversité de science citoyenne. Avec les données de la photo dont la géoréférence et la date, il est possible d'apposer une étiquette comme les naturalistes collectionnaient des organismes à rapporter dans les musées.
...
Une manière de diminuer l'effort que cela prend pour en apprendre sur la biodiversité est de commencer tranquillement avec quelques espèces qui sont faciles à apprendre. Les guides d'identification sont une source importante d'information sur la biodiversité. Par contre, pour un débutant, on peut rapidement être submergé par toutes les espèces et les nuances entre différentes formes d'une même espèce sans accompagnement.

Aussi, même pour ceux qui en font régulièrement, cela peut être encombrant à apporter dans son sac. Les petits dépliants avec les espèces les plus fréquentes semblent un bon milieu entre apporter un guide complet et ne pas avoir de référence. Être sur le terrain avec un groupe de personne dont des enfants, avoir une référence pour montrer à des visiteurs curieux ce que nous observons est intéressant.

L'éditeur Broquet a une collection de [Guides éclair](https://www.broquet.ca/collection/guide-eclair/) sur le thème de la nature. Nous nous inspirons de ce genre de guide pour ce projet. D'autres guides (voir les guides de [Waterford Press](https://www.waterfordpress.com/product)) montrent aussi les domaines biologiques ou les écorégions et les endroits pour aller faire des observations (une vingtaine de point). Pour les données de biodiversité, des observations sont rapportés par des naturalistes débutants ou experts sur des plateformes comme [iNaturalist](https://www.inaturalist.org) ou
...
Je commence par la cartographie puisque nous allons avoir besoin de manipuler de l'information spatiale à un moment. J'assume ici une familiarité avec l'utilisation de R. Si vous cherchez comment débuter en R, je recommande les [ateliers R du Centre de la science de la biodiversité du Québec](https://r.qcbs.ca/fr/).
...
lien_reseau_cycl_mtl = 'data/res_cyclable/reseau_cyclable.geojson'
lien_reseau_cycl_lvl = "data/res_cyclable/pistes-cyclables-et-pietonnieres.geojson"
