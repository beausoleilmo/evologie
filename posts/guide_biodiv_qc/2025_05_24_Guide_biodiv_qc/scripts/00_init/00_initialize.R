...
library(webshot2) # Enregistrer des cartes.
# webshot::install_phantomjs Doit être installé
...
# ____________####
# Charge les fonctions ----------------------------------------------------
source(file = here::here("posts/guide_biodiv_qc/2025_05_24_Guide_biodiv_qc/scripts/00_init/functions.R"))
...
crs_32198 <- readLines(con = here::here("posts/guide_biodiv_qc/2025_05_24_Guide_biodiv_qc/data/param_0/projetCRS.txt"))
