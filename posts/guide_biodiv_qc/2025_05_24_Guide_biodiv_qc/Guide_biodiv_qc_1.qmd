...
Je n'ai pas montré cette carte puisqu'elle n'est pas vraiment belle puisque les polygones sont superposés et empêche de bien voir les détails. Nous pourrions faire une carte qui superpose les *bordures* des régions administratives sur les domaines écologiques. C'est ce que nous allons faire avec une carte statique.
...
```{r exploration_points_visites_ancien, eval=intermap_slow}
